...
tweet_dict_2019 = {t.split("/")[-1].replace(".jpg","").split("_")[1]: t.split("/")[-1].replace(".jpg","") for t in url_2019_all}
...
tweet_dict_2020 = {t.split("/")[-1].replace(".jpg","").split("_")[1]: t.split("/")[-1].replace(".jpg","") for t in url_2020_all}
...
tweet_dict_2021 = {t.split("/")[-1].replace(".jpg","").split("_")[1]: t.split("/")[-1].replace(".jpg","") for t in url_2021_all}
...
tweet_dict_2022 = {t.split("/")[-1].replace(".jpg","").split("_")[1]: t.split("/")[-1].replace(".jpg","") for t in url_2022_all}
...
with open(tweet_file1, mode='r', encoding='utf-8') as infile, open(formatted_tweets_file, mode='w', encoding='utf-8', newline='') as outfile:
    ...
    for row in reader:
        ...
        if row["id"] in tweet_ids_2019:  # filter for relevant tweets
            writer.writerow([row["id"], row["created_at"], row["text"], row["like_count"], row["retweet_count"], row["quote_count"], row["reply_count"], tweet_dict_2019[row["id"]]])
            counter_twids += 1
...
with open(tweet_file2, mode='r', encoding='utf-8') as infile, open(formatted_tweets_file, mode='a', encoding='utf-8', newline='') as outfile:
    ...
    for row in reader:
        ...
        if row["id"] in tweet_ids_2020:  # filter for relevant tweets
            writer.writerow([row["id"], row["text"], row["like_count"], row["retweet_count"], row["quote_count"], row["reply_count"], tweet_dict_2020[row["id"]]])
            counter_twids += 1
...
with open(tweet_file3, mode='r', encoding='utf-8') as infile, open(formatted_tweets_file, mode='a', encoding='utf-8', newline='') as outfile:
    ...
    for row in reader:
        if row["id"] in tweet_ids_2021:  # filter for relevant tweets
            # copy from the original row
            writer.writerow([row["id"], row["text"], row["like_count"], row["retweet_count"], row["quote_count"], row["reply_count"], tweet_dict_2021[row["id"]]])
            counter_twids += 1
...
with open(tweet_file4, mode='r', encoding='utf-8') as infile, open(formatted_tweets_file, mode='a', encoding='utf-8', newline='') as outfile:
    ...
    for row in reader:
        if row["id"] in tweet_ids_2022:  # filter for relevant tweets
            # copy from the original row
            writer.writerow([row["id"], row["text"], row["like_count"], row["retweet_count"], row["quote_count"], row["reply_count"], tweet_dict_2022[row["id"]]])
            counter_twids += 1
